...
export function meta({}: Route.MetaArgs) {
  return [
    { title: "Debugger Test — React Router" },
    { name: "description", content: "Debugger test page for React Router + Vite" },
  ];
}
...
export default function Home() {
  return (
    <div style={{ maxWidth: 800, margin: '0 auto', padding: '32px 16px', fontFamily: 'system-ui, sans-serif' }}>
      <h1 style={{ fontSize: 24, fontWeight: 600, marginBottom: 32 }}>Debugger Test Page — React Router + Vite</h1>
