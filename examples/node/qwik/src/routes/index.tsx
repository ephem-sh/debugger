...
export default component$(() => {
  ...
  return (
    <main style={{ maxWidth: "640px", margin: "0 auto", padding: "32px 16px", fontFamily: "system-ui, -apple-system, sans-serif" }}>
      <h1 style={{ fontSize: "20px", fontWeight: "600", margin: "0 0 24px" }}>Qwik — Debugger Test</h1>

      <section style={{ marginBottom: "24px" }}>
        <h2 style={{ fontSize: "14px", fontWeight: "600", margin: "0 0 8px", color: "#6b7280" }}>Console & Errors</h2>
      ...
      <section style={{ marginBottom: "24px" }}>
        <h2 style={{ fontSize: "14px", fontWeight: "600", margin: "0 0 8px", color: "#6b7280" }}>Network</h2>
        <div style={{ display: "flex", flexWrap: "wrap", gap: "6px" }}>
      ...
      <section>
        <h2 style={{ fontSize: "14px", fontWeight: "600", margin: "0 0 8px", color: "#6b7280" }}>Application State</h2>
        <div style={{ display: "flex", flexWrap: "wrap", gap: "6px" }}>
          ...
          <button style={btnStyle} onClick$={async () => { await removeCookies(); await clearLocal(); await clearSession(); }}>Clear All</button>
        </div>
      </section>
    </main>
  );
